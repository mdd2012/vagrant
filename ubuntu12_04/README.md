...
## 手順
1. Ubuntu 12.04 LTSのサーバーイメージのBOXを取得する
...
2. カレントディレクトリにVagrantfile、localhost、site.ymlを置いた状態でvagrant up!!
```
vagrant up
```

3. 仮想マシンが立ち上がったら、ローカルでsshログインして UbuntuLinux上で ansible-playbookコマンドでプロビジョニング実施
```
$ vagrant ssh
